...
#for showing signup/login button for admin(by vijay)
...
#for showing signup/login button for doctor(by vijay)
...
#for showing signup/login button for patient(by vijay)
...
#-----------for checking user is doctor , patient or admin(by vijay)
def is_admin(user):
